...
function DonationRow(props) {
    return (
        <tr>
            <td>
                <img height={75} width={75} src={props.donation.avatarImageURL} alt="donor-avatar" />
            </td>
            <td>
            ...
            <td>
                {props.donation.message ? (
                    containsBadWord(props.donation.message) ? "⚠️ Watch your language! ⚠️" : props.donation.message
                ) : "No message!"}
            </td>
        </tr>
    );
